    ...
    <section class="other-pages other-body-div" data-aos="fade-down" data-aos-duration="800">
        <div class="other-pages-back-div">
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a href="<?php echo $websiteUrl?>/about-schoolbolt"><li title="About SchoolBolt">About SchoolBolt</li></a>					
                    </ul>
                </div>			
            </div>
            ...
            <div class="main-content-back-div">
                ...
                <div class="image-div">
                    <img src="<?php echo $websiteUrl ?>/all-images/body-pix/how-it-works.png" alt="<?php echo $appName ?> Company" />
                </div>
            </div>
        ...
        <section class="body-div">
            <div class="body-div-in">
                <div class="page-text-content animated fadeIn">
                    <p><strong>“SchoolBolt”</strong> is web application software, which aims at providing school management services to basic/secondary schools, selecting the legitimate staff by the school administrator.</p>
                    <p>The web application is being launched for a destination that is beneficial to both the school management, Parents and students.</p>
                    ...
                    <div class="about-details-back-div">
                        <div class="text-div" data-aos="fade-in" data-aos-duration="1200">
                            ...
                            <p><strong>1.</strong> Fed up struggling with a system which seems to add to your workload, which does not work the way your school does? </p>
                            <p><strong>2.</strong> Do you want a scalable computerized system with plenty of timesaving features that help to get jobs done quickly and accurately? </p>
                            <p><strong>3.</strong> Do you want professional-looking reports and correspondence? </p>
                        </div>
                    </div>

                    <p>This application fulfils the requirements of any basic/secondary school to manage the school modules such as staff, students, financial transactions, Continuous Assessment, examination records, Broad Sheets, Score Sheets, BECE Requirements, Student Transcripts, Physical/Online Class, Auto Admission and Progressive Report Sheets.</p>
                    <p><strong>“SchoolBolt”</strong> web application is an attempt to remove the existing flaws in the manual system of school managements. it is an innovative solution for today's school record-keeping challenges which gives rooms to handle your responsibilities whether you are just starting or an experienced professional.</p>
                    <p><strong>“SchoolBolt”</strong> opens the door to many of the unique advantages and benefits as a result of the skills, resources and world-wide exposure that your school can provide.</p>
                    <p class="red-text">With our experience, expertise and resources at your disposal, you have the assurance that your school is in safe hands at little or no cost</p>
                    <h2>SchoolBolt <span>Technical Details</span></h2>
                    <p>SchoolBolt Application is designed using Hypertext Mark-up Language (HTML), PHP programming language for the middleware, MySql database for the back-end, JavaScript, VB Script and JQuery for slides and animation, CSS for well-structured interfaces.</p>
                    <p>These programming tools assisted AfooTech IT Solution in designing a secured web application, free from internet treats, hacking, unauthorized privileges and well-structured layout that improve users' interaction, easy to access and navigate.</p>
                </div>
            </div>
        </section>
