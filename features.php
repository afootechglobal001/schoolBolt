        ...
        <section class="body-div">
            <div class="body-div-in">
                <div class="page-text-content animated fadeIn">
                    <p>The main objective of this system is to create a computerized system for effective and efficient basic/secondary school management. The priority of the system is easy to use and able to keep information organized. Hopefully the system will act as the first step towards realizing the dream of becoming a paperless society</p>
                    <p>This application is designed to track the following;</p>
                    <p><strong>1.</strong> Digital entrance examination.</p>
                    <p><strong>2.</strong> Automated admission process.</p>
                    <p><strong>3.</strong> The mode of operation in any basic/secondary school;</p>
                    <p><strong>4.</strong> The data of all the staff in the school;</p>
                    <p><strong>5</strong> The data of all the students in the school;</p>
                    <p><strong>6.</strong> The academic report of each staff;</p>
                    <p><strong>7.</strong> The academic report of each student;</p>
                    <p><strong>8.</strong> Online learning management system (LMS);</p>
                    <p><strong>9.</strong> Theoretical CBT examination system;</p>
                    <p><strong>10.</strong> Promote and demote student based on academic performance;</p>
                    <p><strong>11.</strong> To provide an identification card for both staff and students;</p>
                    <p><strong>12.</strong> To generate school time table term by term;</p>
                    <p><strong>13.</strong> To manage the staff and students' transactions;</p>
                    <p><strong>14.</strong> Print student terminal results and transcripts;</p>
                    <p><strong>15.</strong> Salary schedule and bursary management system;</p>
                    <p><strong>16.</strong> Score sheet, broad sheet and BECE requirements information;</p>
                    <p><strong>17.</strong> Customer Relation Management (CRM);</p>
                    <p><strong>18.</strong> Hostel and logistics managements;</p>
                    <p><strong>19.</strong> Lesson note and related document management;</p>
                    <p><strong>20.</strong> Digital marketing and official mailing system.</p>
                    <p><strong>21.</strong> Staff and student attendance management;</p>
                    <p><strong>22.</strong> E-Library.</p>

                    <h2>Benefits Of <span>SchoolBolt</span></h2>
                    <p>You will have the benefit of a full service contract which will cover every aspect of operational services.</p>
                    <p> Not only will you have peace of mind in the knowledge that your school is being managed optimally towards increase profitability, but you will also be relieved of the responsibility for having to carry out the often difficult tasks of:</p>
                    <ul>
                        <li>Recruiting the school teaching and non-teaching staff.</li>
                        <li>Carrying out financial management, Our team have extensive experience in managing School at the highest level. We have your interests at heart and our contract promise represents years of experience in satisfying clients like yourself.</li>
                    </ul>
                    <p>The contract embodies the principles of dedicated service and commitment and is a solid way of optimising your investment return and capital growth. </p>
                </div>
            </div>
        </section>
