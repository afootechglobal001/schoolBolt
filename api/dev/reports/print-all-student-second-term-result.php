...
if (!$checkBasicSecurity){/// start if 1
    ...
    /// get all tableTitles
    $tableTitles="SN, SUBJECTS, FIRST TERM SCORE (100)";
    ...
    $tableTitles .=",TOTAL SCORE(100), THIRD TERM SCORE (100), MIN SCORE, MAX SCORE, AVERAGE SCORE, POSTN. IN CLASS, GRADE, REMARKS";
