...
if (!$checkBasicSecurity){/// start if 1
    ...
    $branchDataQuery = mysqli_query($conn, "SELECT name AS branchName, schoolLogo, principalSignature, address, supportEmail, mobileNumber, timeSchoolOpened, schoolResumptionDate, schoolCategoryId, progressReportHeader, watermark FROM BRANCHES_TAB WHERE $clientIds AND branchId='$branchId'");
    ...
    $response['message']="TERMINAL PROGRESSIVE RESULT FETCHED  SUCCESFFULY!";
   ...
   $response['eachStudentResultData'] = array();
    ...
    while ($terminalfetch = mysqli_fetch_assoc($terminalQuery)){ 
        ...
        while ($fetchQuery = mysqli_fetch_assoc($query)) {
            ...
            $terminalfetch['progressiveReportData'][] = $fetchQuery;
        }
