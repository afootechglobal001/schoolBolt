...
if(!$checkSession){
    ...
    if(empty($statusId)){
        ...
        goto end;
			...
			$query=mysqli_query($conn,"SELECT * FROM PRODUCTS_TAB WHERE productLevel=1 AND  productName='$productName' AND productId!='$productId'") or die (mysqli_error($conn));
            ...
            `productName`='$productName', `productTags`='$productTags', `statusId`='$statusId', `updatedBy`='$loginStaffId', 
