...
if(!$checkSession){
    ...
    if(empty($statusId)){
        ...
        if(!filter_var($emailAddress, FILTER_VALIDATE_EMAIL)){
			...
			$query=mysqli_query($conn,"SELECT * FROM STAFF_TAB WHERE emailAddress='$emailAddress' AND staffId!='$staffId'") or die (mysqli_error($conn));
            ...
            `updatedBy`='$loginStaffId', `updatedTime`=NOW() WHERE staffId='$staffId'")or die (mysqli_error($conn));
