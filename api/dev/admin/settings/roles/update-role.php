...
if(!$checkSession){
    ...
    if(count($rolePermissionIds)==0){
        ...
        goto end;
			...
			$query=mysqli_query($conn,"SELECT * FROM ROLE_TAB WHERE roleName='$roleName' AND roleId!='$roleId'") or die (mysqli_error($conn));
            ...
            WHERE roleId = '$roleId'")or die (mysqli_error($conn));
