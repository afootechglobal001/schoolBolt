...
if(!$checkSession){
    ...
    $branchDataQuery = mysqli_query($conn, "SELECT name AS branchName, schoolLogo, address, smtpUsername, mobileNumber, session , termName FROM BRANCH_VIEW WHERE $clientIds AND branchId='$branchId'");
