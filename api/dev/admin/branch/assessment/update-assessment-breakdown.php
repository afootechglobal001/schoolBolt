...
if(!$checkSession){
    ...
    if($assessmentTotalScore<0){
        ...
        goto end;
			...
			$query=mysqli_query($conn,"SELECT * FROM BRANCH_ASSESSMENT_SETUP_TAB WHERE $clientIds AND branchId='$branchId' AND parentId='$parentId' AND assessmentName='$assessmentName' AND assessmentId!='$assessmentId'") or die (mysqli_error($conn));
            ...
            $sumQuery = mysqli_query($conn, "SELECT SUM(assessmentTotalScore) AS totalScore FROM BRANCH_ASSESSMENT_SETUP_TAB WHERE $clientIds AND branchId='$branchId' AND parentId='$parentId' AND assessmentId!='$assessmentId'") or die (mysqli_error($conn));
            ...
            mysqli_query($conn,"UPDATE `BRANCH_ASSESSMENT_SETUP_TAB` SET
             ...
             WHERE $clientIds AND branchId='$branchId' AND parentId='$parentId' AND assessmentId='$assessmentId'")or die (mysqli_error($conn));
