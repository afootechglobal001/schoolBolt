...
function _fetchBranchDepartmentClass() {
    ...
    $('#branchClassPageContent').html('<div class="ajax-loader pages-ajax-loader"><img src="' + websiteUrl + '/images/spinner.gif" alt="Loading"/></div>').fadeIn("fast");
        ...
        $.ajax({
            ...
            success: function(info) {
                ...
                if (success === true) {
                                        ...
                                        text += `
                                            <tr class="tb-row">
												...
												if (teacherData && typeof teacherData) {
													...
													<td>
													 	<div class="btn-div">
															<button class="btn view-btn" title="Click to edit assign class teacher" onclick="_fetchClassTeacher('${departmentId}','${classId}','${armId}');"><i class="bi-bookmark-check"></i> ASSIGN</button>
														</div>
													</td>`;
												}
												`</tr>`;
                    ...
                    $('#branchClassPageContent').html(text);
                } else {
                    _actionAlert(info.message, false);
                    $('#branchClassPageContent').html(`
                        <tbody>
                            <tr>
                                <td colspan="15">
