...
<link href="<?php echo $websiteUrl ?>/style/paramount.css?v=<?php echo $codeVersion ?>" type="text/css"
    rel="stylesheet" />
<link href="<?php echo $websiteUrl ?>/style/parent/auth-style.css?v=<?php echo $codeVersion ?>" type="text/css"
    rel="stylesheet" />
...
<script src="<?php echo $websiteUrl ?>/js/parent/usePortalResult.js?v=<?php echo $codeVersion ?>"></script>
<script src="<?php echo $websiteUrl ?>/js/parent/usePortalPayment.js?v=<?php echo $codeVersion ?>"></script>
