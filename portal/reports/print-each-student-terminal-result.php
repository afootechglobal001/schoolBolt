...
<body>
    ...
    <div class="download-area-wrapper">
        <div class="download-area">
            <div class="btn-container">
                ...
                <button class="btn print-btn" id="printBtn" title="Print Result" onclick="window.print()">
    ...
    <script>
        const fileStudentName = printEachStudentTerminalResultSession?.studentData?.surName + '-' +
        printEachStudentTerminalResultSession?.studentData?.firstName + '-' +
        printEachStudentTerminalResultSession?.studentData?.otherNames;

        const fileTermName= printEachStudentTerminalResultSession?.termData?.termName;

        function _downloadLetter(){
            let element = document.getElementById("body-wrapper");
            let options = {
                margin: [0.0, -0.9000, 0.0, 0.0],
                filename: `${capitalizeFirstLetterOfEachWord(fileStudentName)}-${capitalizeFirstLetterOfEachWord(fileTermName)}-Result.pdf`,
                image: {
                    type: 'jpeg',
                    quality: 1
                },
