            ...
            <div class="header-div">
                <div class="inner-div">
                    ...
                    <div class="text-div">
                        <h3 id="branchName">
                            <script>
                                $("#branchName").html(printTerminalResultSummarySession?.branchData?.branchName);
                            </script>
                        </h3>
                        <div class="text">Address: <strong id="address">
                                <script>
                                    $("#address").html(printTerminalResultSummarySession?.branchData?.address);
                                </script>
                            </strong></div>
                        <div class="text">Phone: <strong id="mobileNumber">
                                <script>
                                    $("#mobileNumber").html(printTerminalResultSummarySession?.branchData?.mobileNumber);
                                </script>
                            </strong> | Official Email: <strong id="smtpUsername">
                                <script>
                                    $("#smtpUsername").html(printTerminalResultSummarySession?.branchData?.supportEmail);
                                </script>
                            </strong></div>
                    </div>
                </div>
