...
<head>
    ...
    <title>Alumni Student List | <?php echo $clientName ?></title>
</head>

<body>
    <script> printAlumniStudentByClassSession = JSON.parse(sessionStorage.getItem("printAlumniStudentByClassSession"));</script>
    ...
    <section class="body-div" id="backgroundTable" style="background: url(../images/report/watermark.jpg) center no-repeat;">
        <div class="header-back-div">
            ...
            <div class="title-div">
                ...
                <script>
                    $("#titleDetails").html(printAlumniStudentByClassSession?.alumniSession + ' - ' +
                    printAlumniStudentByClassSession?.departmentData?.departmentName + ' - ' + 
                    printAlumniStudentByClassSession?.classData?.className + ' ' + 
                   printAlumniStudentByClassSession?.armData?.armName + ' LIST');
                </script>
            </div>
        </div>
                ...
                <table class="table" cellspacing="0" style="width:100%" id="pageContent">
                    <script>
                        $(document).ready(function() {
                            const printAlumniStudentByClassSession = JSON.parse(sessionStorage.getItem("printAlumniStudentByClassSession"));
                            ...
                            text =`
                                ...
                                if (printAlumniStudentByClassSession && printAlumniStudentByClassSession.success === true) {
                                    const students = printAlumniStudentByClassSession.data;
                                    const session = printAlumniStudentByClassSession?.alumniSession;
