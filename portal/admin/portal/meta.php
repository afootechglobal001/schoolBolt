...
<link href="<?php echo $websiteUrl?>/style/admin/main-style.css?v=<?php echo $codeVersion?>" type="text/css" rel="stylesheet" />
...
<script src="<?php echo $websiteUrl?>/js/reports/print-result-summary.js?v=<?php echo $codeVersion?>"></script>