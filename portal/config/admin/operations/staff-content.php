...
<div class="user-in">
    ...
    <div class="btn-div" id="staffBtn">
        <script>
        if ((userRoles.canViewSuperAdminDashboard || userRoles.canViewAdministratorDashboard || userRoles
                .canViewIctStaffDashboard)) {
            let buttonContent = "";
...
<div class="slide-form-div save-compute-teachers-comment-slide-form" data-aos="fade-left" data-aos-duration="900">
    ...
    <div class="container-back-div">
        <div class="inner-container">
                    ...
                    if (getClassTeacherCommentDataSession) {
                        ...
                        if (success === true && fetchData.length > 0) {
                            ...
                            $(document).on('change', '.comment-radio', function() {
                                ...
                                $(`input[name='${studentGroupName}']`).closest('.each-radio-div')
            ...
            <div>
                <button class="btn" title="SAVE CLASS TEACHER'S COMMENT" id="submitBtn"
                    onclick="_saveClassTeachersComment();">
                    <i class="bi-save"></i> SAVE
                </button>
            </div>
        </div>
...
<div class="caption-div animated zoomIn">
    ...
    <div class="div-in animated fadeIn">
        <div class="alert alert-success form-alert"> <i class="bi-person"></i> Hello, you're about to change your staff
            password. Please enter sraff new and confirm password below.</div>
        <div class="pswd_info" style="color:#8c8d8d"><em>At least 8 charaters required including upper & lower cases and
                special characters and numbers.</em></div>
        ...
        <button class="btn" title="CHANGE STAFF PASSWORD" id="changeStaffPasswordBtn" onclick="_changeStaffPassword();">
            <i class="bi-check"></i> CHANGE PASSWORD </button>
    </div>
</div>
<?php } ?>