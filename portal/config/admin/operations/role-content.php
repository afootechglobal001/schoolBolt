<?php if ($page == 'user-role-configuration') { ?>
    <div class="page-title-back-div other-pages-title-back-div" data-aos="fade-in" data-aos-duration="1500">
        <div class="page-title-div">
            <div class="back-div"><span onclick="_getActivePage({page:'settings'});"><i class="bi-arrow-left"></i> System
                    Settings</span> Role And Permissions</div>
        ...
        <div class="other-pages-filter-div">
            ...
            <div class="btn-div">
                <button class="btn" title="ADD NEW ROLE"
                    onclick=" sessionStorage.removeItem('getEachRoleDetails'); _getForm({page: 'role_reg', url: adminPortalLocalUrl});">
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                <div>
                    <div class="alert alert-success form-alert">Kindly fill the form below and toggle permissions to<span>
                            ADD NEW USER ROLE</span></div>
                </div>
                ...
                <div class="permission-form-back-div">
                    <div class="title-div">
                        <h4>Permissions</h4>
                        <p>Every user has a default permission to view dashboard overview. You can customized other settings
                            and permissions based on individual privileges</p>
                    </div>
                    ...
                    <div class="permission-toggle-div">
                        <div class="toggle-title">CBT Permissions</div>
                        <div class="fetch-toggle" id="cbt"></div>
                    </div>
                ...
                <div>
                    <button class="btn" title="SUBMIT" id="submitBtn" onclick="_createUpdateRole();"> <i
                            ...
                            <script>
                                $(document).ready(function () {
                                    ...
                                    for (let i = 0; i < getEachRoleDetails.rolePermissions.length; i++) {
                                        const rolePermissionName = getEachRoleDetails.rolePermissions[i]
                                            .rolePermissionName;
                        ...
                        <div class="details-list">
                            ...
                            <div class="each-details-back-list">
                                <div class="each-details-list">
                                    ...
                                    <span id="fullName">
                                        <script>
                                            $("#fullName").html(capitalizeFirstLetterOfEachWord(getEachRoleDetails.createdBy[0]
                                                .fullname));
                                        </script>
                                    </span>
                                </div>
                        ...
                        <div class="details-list">
                            ...
                            <div class="each-details-back-list">
                                <div class="each-details-list">
                                    ...
                                    <span id="fullName2">
                                        <script>
                                            $("#fullName2").html(capitalizeFirstLetterOfEachWord(getEachRoleDetails.updatedBy[0]
                                                ?.fullname ?? ''));
                                        </script>
                                    </span>
                                </div>
