        ...
        <div class="left-dashbaord-container">
            <div class="statistics-chart-back-div">
                <div class="new-statistics-back-div">
                    <div class="new-statistics-div" id="branch" title="Staffs" onclick="_getActiveBranchPage({divid:'branch_staff', page: 'branch_staff', url: adminPortalLocalUrl});">
                    ...
                    <div class="new-statistics-div" title="Subjects" onclick="_getForm({page: 'subject_select_form', layer:2, url: adminPortalLocalUrl});">
                        <div class="statistics-inner-div">
                            <div class="statistics-text">
                                <p>Subjects</p>
                    ...
                    <div class="new-statistics-div" id="branch_department_class" onclick="_getActiveBranchPage({divid:'branch_department_class', page: 'branch_department_class', url: adminPortalLocalUrl});" title="Class">
                        <div class="statistics-inner-div">
                            <div class="statistics-text">
                                <p>Class</p>
