        ...
        <div class="profile-content-div">
            <div class="bg-img">
                <div class="mini-profile">
                    <div class="btn-div">
                        <button class="btn" title="Take Student Picture" onClick="takeSnapShot('updateStudentPix')">
                            <i class="bi-camera-fill"></i></button>

                        <input id="browseImageInput" type="file" style="display:none;"
                            accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif"
                            onchange="studentPixPreview.UpdatePreview(this, 'updateStudentPix');" />
                    ...
                    <ul>
                        ...
                        <li class="hide-li" id="dotted" title="Student Account"><i class="bi-credit-card"></i> Student
                            ...
                            <ul class="animated fadeIn">
                                ...
                                <li title="Discount/Scholarship Application" id="studentDiscountScholarship"
                                    onclick="_getActiveStudentPage({divid:'studentDiscountScholarship', page: 'studentDiscountScholarship', url: adminPortalLocalUrl});">
                                    <i class="bi-mortarboard"></i>Discount/Scholarship Application
                                </li>
                            </ul>
                        </li>
                ...
                <div class="custom-srch-div">
                    <div class="custom-srch-div-in">
                        ...
                        <div class="text_field_container dash_field_container">
                            <input class="text_field dash_text_field bar_cust_text_field" type="text" id="datepickers-to"
                                placeholder="" />
                            <div class="placeholder dash_placeholder bar_cust_placeholder"><i class="bi-calendar3"></i> To
                            </div>
                        </div>
                        <button type="button" class="btn">Apply</button>
                    </div>
...
<?php if ($page == 'payableFess') { ?>
    <script>
        studentCurrentPayableFeesSession = JSON.parse(sessionStorage.getItem("studentCurrentPayableFeesSession"));
    </script>
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    if (studentCurrentPayableFeesSession && studentCurrentPayableFeesSession.data) {
                                        ...
                                        $("#mandatoryFees").html(mandatoryFees !== '' ? mandatoryFees :
                                            'No record found!');
                                        _toggleCheck();
                                    }
                                });
                ...
                <div>
                    <button class="btn" title="SAVE FEES" id="submitBtn" onclick="_updateStudentMandatoryFess();"> <i
...
<!-- For Archived Students Page -->
<?php if ($page == 'branch_archived_students') { ?>
    <div class="alert alert-success form-alert animated fadeIn">
        ...
        <div class="long-search-div archived-search-div">
            <div class="text_field_container search_field_container">
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormFullName">
                                            <script>
                                                $("#accountFormFullName").html(useAccountFessToPaySession?.studentData
                                                    ?.fullName);
                                            </script>
                                        </span></div>
                                </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormBranchName">
                                            <script>
                                                $("#accountFormBranchName").html(useAccountFessToPaySession?.branchData
                                                    ?.branchName);
                                            </script>
                                        </span></div>
                                </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormDepartment">
                                            <script>
                                                $("#accountFormDepartment").html(useAccountFessToPaySession?.departmentData
                                                    ?.departmentName);
                                            </script>
                                        </span></div>
                                </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormClass">
                                            <script>
                                                $("#accountFormClass").html(useAccountFessToPaySession?.classData?.className +
                                                    ' ' + useAccountFessToPaySession?.armData?.armName);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormCurrentSession">
                                            <script>
                                                $("#accountFormCurrentSession").html(useAccountFessToPaySession
                                                    ?.currentSession);
                                            </script>
                                        </span></div>
                                </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="accountFormCurrentTerm">
                                            <script>
                                                $("#accountFormCurrentTerm").html(useAccountFessToPaySession?.termData
                                                    ?.currentTerm);
                                            </script>
                                        </span></div>
                                </div>
                ...
                <div>
                    <button class="btn" title="Pay Student Fund" id="submitBtn" onclick="_loadStudentFund();"> <i
                            class="bi-check"></i> LOAD FUND </button>
                </div>
            </div>
        </div>
    </div>
...
<!-- For Student Transaction History Page -->
<?php if ($page == 'studentFundHistory') { ?>
    <div class="chart-div-notifications user-details-notf">
        <div class="text-back-div">
            <div class="text"><i class="bi-graph-up-arrow"></i> Showing Fund History for </div>

            <div class="text text-right" onclick="studentFundSelectSearch()">
                <span id="srch-student-fund-text">Last 30 Days</span>
                <div class="icon-div"><i class="bi-caret-down"></i></div>

                <div class="srch-select student-fund-srch-select">
                    <div id="srch-today" onclick="_fetchStudentFundFiltering('srch-today', 'Today');">Today</div>
                    <div id="srch-week" onclick="_fetchStudentFundFiltering('srch-week', 'This Week');">This Week</div>
                    <div id="srch-7" onclick="_fetchStudentFundFiltering('srch-7', 'Last 7 Days');">Last 7 Days</div>
                    <div id="srch-month" onclick="_fetchStudentFundFiltering('srch-month', 'This Month');">This Month</div>
                    <div id="srch-30" onclick="_fetchStudentFundFiltering('srch-30', 'Last 30 Days');">Last 30 Days</div>
                    <div id="srch-90" onclick="_fetchStudentFundFiltering('srch-90', 'Last 90 Days');">Last 90 Days</div>
                    <div id="srch-year" onclick="_fetchStudentFundFiltering('srch-year', 'This Year');">This Year</div>
                    <div id="srch-1year" onclick="_fetchStudentFundFiltering('srch-1year', 'Last 1 Year');">Last 1 Year
                    </div>
                    <div onclick="studentFundSrchCustom('Custom Search')">Custom Search</div>
                </div>
            </div>

            <div class="text">
                <div class="custom-srch-div student-fund-custom-srch-div">
                    <div class="custom-srch-div-in">
                        <div class="text_field_container dash_field_container">
                            <input class="text_field bar_cust_text_field" type="text" id="student-fund-datepickers-from"
                                placeholder="" />
                            <div class="placeholder bar_cust_placeholder"><i class="bi-calendar3"></i> From
                            </div>
                            <div class="issueText" id="issue_student-fund-datepickers-from"></div>
                        </div>

                        <div class="text_field_container dash_field_container">
                            <input class="text_field bar_cust_text_field" type="text" id="student-fund-datepickers-to"
                                placeholder="" />
                            <div class="placeholder bar_cust_placeholder"><i class="bi-calendar3"></i> To </div>
                            <div class="issueText" id="issue_student-fund-datepickers-to"></div>
                        </div>
                        <button type="button" class="btn" id="applystudentFundCustomSearchBtn"
                            onclick="_fetchCustomStudentFundFiltering();">Apply</button>
                    </div>
                </div>
            </div>

            <script language="javascript">
                $('#student-fund-datepickers-from').datetimepicker({
                    lang: 'en',
                    timepicker: false,
                    format: 'Y-m-d',
                    formatDate: 'Y-M-d',
                ...
                $('#student-fund-datepickers-to').datetimepicker({
                    lang: 'en',
                    timepicker: false,
                    format: 'Y-m-d',
                    formatDate: 'Y-M-d',
        ...
        <div class="wallet-balance">
            Advanced Balance: <span class="balance" id="advancedBalance"><s>N</s>0.00</span>
        </div>
    </div>

    <div class="alert alert-success top-alert-div animated fadeIn">
        <div><i class="bi-info-circle"></i> Wallet history between <span id="dateFrom">Loading...</span> and <span
