    ...
    <div class="branch-account-wrapper">
        <div class="nav-content-back-div">
            <div class="nav-container branch-account-nav">
                <ul>
                    <li class="active border" title="Filter Transaction By Date Range" id="filterBranchByDate"
                        onclick="">
            ...
            <div>
                ...
                <div class="fetch-report-back-div">
                    <div class="alert alert-success top-alert-div report-alert">
                        ...
                        <div class="div">
                            Total Transaction: <span class="balance" id="totalRevenue">N347,000.00</span>
                        </div>
                    </div>
                                    ...
                                    <div class="table-div animated fadeIn">
                                        <table class="table" cellspacing="0" style="width:100%">
                                            ...
                                            <tbody id="pageContent">
                                                <tr class="tb-row">
                                                    <td>1</td>
                                                    <td class="clickable-td" title="Click to view transaction breakdown" onclick="_getForm({ page: 'branchTransactionRecordBreakdowns', id: '${newpayDate}', layer:2, url: adminPortalLocalUrl});">2026-04-17</td>
                                                    <td><s>N</s>20,000.00</td>
                                                    <td><button class="btn view-btn" title="Click to view transaction breakdown" onclick="_getForm({ page: 'branchTransactionRecordBreakdowns', id: '${newpayDate}', layer:2, url: adminPortalLocalUrl});">VIEW DETAILS</button></td>
                                                </tr>
                                                <!-- <tr>
                                                    <td colspan="20">
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<?php if ($page == 'branchTransactionRecordBreakdowns') { ?>
                        ...
                        <div class="header-div">
                            <div class="title-nav-back-div">
                                <div class="nav-ul-div">
                                    <ul>
                                        <li class="active-li" title="Successful Status" id="branchSuccessfulPage"><img src="<?php echo $websiteUrl ?>/images/tick-mark.png" alt="Successful Icon" /> SUCCESSFUL</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
