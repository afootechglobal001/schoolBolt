                    ...
                    <div class="alert alert-success form-alert">
                                            ...
                                            <div class="alert-list-div">
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayFullName">
                                                                <script>
                                                                    $("#studentPayFullName").html(useAccountFessToPaySession
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayBranchName">
                                                                <script>
                                                                    $("#studentPayBranchName").html(useAccountFessToPaySession
                                                                        ?.branchData
                                                                        ?.branchName);
                                                                </script>
                                                            </span></div>
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayDepartment">
                                                                <script>
                                                                    $("#studentPayDepartment").html(useAccountFessToPaySession
                                                                        ?.departmentData
                                                                        ?.departmentName);
                                                                </script>
                                                            </span></div>
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayClassName">
                                                                <script>
                                                                    $("#studentPayClassName").html(useAccountFessToPaySession
                                                                        ?.classData
                                                                        ?.className + ' ' + useAccountFessToPaySession
                                                                            ?.armData?.armName);
                                                                </script>
                                                            </span></div>
                                                    </div>
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayCurrentSession">
                                                                <script>
                                                                    $("#studentPayCurrentSession").html(
                                                                        useAccountFessToPaySession?.currentSession);
                                                                </script>
                                                            </span></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentPayCurrentTerm">
                                                                <script>
                                                                    $("#studentPayCurrentTerm").html(useAccountFessToPaySession
                                                                        ?.termData
                                                                        ?.currentTerm);
                                                                </script>
                                                            </span></div>
                                                ...
                                                <div class="alert-list-back-div">
                                                    <div class="alert-list">
                                                        ...
                                                        <div><span id="studentAdvancedBalance">
                                                                <script>
                                                                    $("#studentAdvancedBalance").html('<s>N</s>' +
                                                                        thousandSeperator(
                                                                            getEachAccountStudentSession?.studentData
                                                                                ?.advancedBalance));
                                                                </script>
                                                            </span></div>
                                                    </div>
                        ...
                        <div class="permission-form-back-div account-permission-form-back-div">
                            <div class="title-div">
                                ...
                                <p>Type the amount or percentage for each fee below. The system will automatically calculate
                                    the
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            let upPaidFees = false; <
                                                ...
                                                const NewFeesOption = (feesOption === "TRUE") ?
                                                "MANDATORY" :
                                                "NOT MANDATORY";
                                                const feesOptionColor = (feesOption === "TRUE") ?
                                                "green-color" :
                                                "orange-color";
                                                const amount = thousandSeperator(fetchedFess
                                                .amount);
                                                                    ...
                                                                    <
                                                                        ...
                                                                        <
                                                                            ...
                                                                            const feesPaidData =
                                                                                    ...
                                                                                    for (let i = 0; i < feesPaidData
                                                                                        .length; i++) {
                                                                                const fetchFeesPaid = feesPaidData[i];
                                                                                    const totalAmountPaid =
                                                                                    thousandSeperator(fetchFeesPaid
                                                                                    .totalAmountPaid);
                                                                                    const totalFeesPercentage =
                                                                                    fetchFeesPaid.totalFeesPercentage;
                                                                                    const feesName = fetchFeesPaid.feesName;
                                                                                    const percentageColor =
                                                                                    totalFeesPercentage >= 100 ?
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div>
                                        ...
                                        <script>
                                                                                        $("#walletBalance").html('<s>N</s>' + thousandSeperator(
                                                                                        useAccountFessToPaySession
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div>
                                        ...
                                        <script>
                                                                                        $("#schoolBoltCharges").html('<s>N</s>' + thousandSeperator(
                                                                                        useAccountFessToPaySession
                                                                                        ?.schoolBoltCharges));
                                        </script>
                                    </div>
                                ...
                                <script>
                                    ...
                                    const response = JSON.parse(sessionStorage.getItem(
                                        ...
                                        data.forEach(item => {
                                                                                                ...
                                                                                                const outstandingBalance = item.outstandingBalance;
                                            const outstandingStatus = outstandingBalance > 0 ?
                                                                                                "red-color" :
                                                                                                "green-color";
                                ...
                                <div class="alert-list-back-div">
                                    <div class="alert-list">
                                        ...
                                        <div><span id="studentPayFullName">
                                                <script>
                                                                                            $("#studentPayFullName").html(getEachAccountStudentSession?.studentData
                                                                                            ?.surName + ' ' + getEachAccountStudentSession?.studentData
                                                                                            ?.firstName +
                                                                                            ' ' + getEachAccountStudentSession?.studentData?.otherNames);
                                                </script>
                                            </span></div>
                                                ...
                                                <div class="alert-list-div">
                                                    <div class="alert-list-back-div">
                                                        <div class="alert-list">
                                                            ...
                                                            <div><span id="debotorStudentPayFullName">
                                                                    <script>
                                                                                            $("#debotorStudentPayFullName").html(
                                                                                            useAccountFessToPaySession?.studentData
                                                                                            ?.fullName);
                                                                    </script>
                                                                </span></div>
                                                        </div>
                                                    ...
                                                    <div class="alert-list-back-div">
                                                        <div class="alert-list">
                                                            ...
                                                            <div><span id="studentPayBranchName">
                                                                    <script>
                                                                                            $("#studentPayBranchName").html(
                                                                                            useAccountFessToPaySession?.branchData
                                                                                            ?.branchName);
                                                                    </script>
                                                                </span></div>
                                                        </div>
                                                    ...
                                                    <div class="alert-list-back-div">
                                                        <div class="alert-list">
                                                            ...
                                                            <div><span id="studentPayDepartment">
                                                                    <script>
                                                                                            $("#studentPayDepartment").html(
                                                                                            useAccountFessToPaySession?.departmentData
                                                                                            ?.departmentName);
                                                                    </script>
                                                                </span></div>
                                                        </div>
                                                    ...
                                                    <div class="alert-list-back-div">
                                                        <div class="alert-list">
                                                            ...
                                                            <div><span id="studentPayClassName">
                                                                    <script>
                                                                                            $("#studentPayClassName").html(
                                                                                            useAccountFessToPaySession?.classData
                                                                                            ?.className + ' ' +
                                                    ...
                                                    <div class="alert-list-back-div">
                                                        <div class="alert-list">
                                                            ...
                                                            <div><span id="studentPayCurrentTerm">
                                                                    <script>
                                                                                            $("#studentPayCurrentTerm").html(
                                                                                            useAccountFessToPaySession?.termData
                                                                                            ?.currentTerm);
                                                                    </script>
                                                                </span></div>
                                                        </div>
                                        ...
                                        <script>
                                                    ...
                                                    div class="alert-list-div"
                                                        ...
                                                        script >
                                                                                                    ...
                                                                                                    if (useAccountFessToPaySession &&
                                                                                                    useAccountFessToPaySession.data) {
                                                                const fetch = useAccountFessToPaySession.data;
                                        ...
                                        for (let i = 0; i < feesPaidData.length; i++) {
                                            ...
                                            $("#debtorPaidFees").append(` <
                                                                            ...
                                                                            div class="alert-value" >
                                                                                                                <
                                                                            span class=
                                                                                                                    "alert-percentage ${percentageColor}" >
                                                                                                                    $ {
                                                                                                                        totalFeesPercentage
                                                                                                                    } % < /span> <
                                                                                                                        span > < s > N <
                                                                            /s>${totalAmountPaid}</span >
                                                                                                                    <
                                                                            /div> <
                                                                            /div>`;
                                                                            }
                                                    ...
                                                    const response = JSON.parse(sessionStorage.getItem(
                                                        ...
                                                        data.forEach(item => {
                                                                ...
                                                                data.forEach(item => {
                                                                                                                            ...
                                                                                                                            const advancedBalance = student.advancedBalance;
                                                                                                                            const isDebtor = item.isDebtor;
                                                                                                                            const isResultActivated = item
                                                                                                                            .isResultActivated;
                                                                                                                            const outstandingBalance = item
                                                                                                                            .outstandingBalance;
                                                                                                                            const debtorStatusColor = (isDebtor ===
                                                                                                                            "TRUE") ? "red-color" : "green-color";
                                                                                                                            const debtorImgStatusColor = (isDebtor ===
                                                                                                                            "TRUE") ?
                                                                                                                            '<div class="status-icon debtor"><i class="bi-x"></i></div>' :
                                                                                                                            '<div class="status-icon"><i class="bi-check"></i></div>';
