...
<div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            <div>
                <div class="alert alert-success form-alert">Kindly fill the form below to <span id="subTitle"> ADD NEW
                        BANK</span></div>
            </div>
...
<div class="table-div animated fadeIn">
    <table class="table" cellspacing="0" style="width:100%" id="pageContent">
        ...
        <tbody id="fetchBankTransactionRecordPageContent">
            <script>
            _fetchBranchBankTransactionRecord();
            </script>
            <tr>
                <td colspan="20">
                    <div class="content-loading-div">
...
$('#bankTransPageTitle').html(useEachBankTransactionRecordSession?.transactionId ? 'UPDATE BANK TRANSACTION' :
    'ADD NEW BANK TRANSACTION');
$('#bankTransSubTitle').html(useEachBankTransactionRecordSession?.transactionId ? 'UPDATE BANK TRANSACTION' :
    'ADD NEW BANK TRANSACTION');
</script>
...
<div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            <div>
                <div class="alert alert-success form-alert">Kindly fill the form below to <span id="bankTransSubTitle">
                        ADD
