...
<?php if ($page == 'accountSessionSelectForm') { ?>
    <div class="caption-div animated zoomIn">
        ...
        <div class="div-in animated fadeIn">
            ...
            <button class="btn" id="proceedBtn" title="Proceed Request" onclick="_proceedFetchAcountDepartmentClass();">PROCEED <i
                    class="bi-arrow-right"></i> </button>
        </div>
    </div>
<?php } ?>
...
<?php if ($page == 'branchDepartmentClass') { ?>
    ...
    <div class="alert alert-success top-alert-div animated fadeIn">
        <div><span><i class="bi-people-fill"></i> BRANCH DEPARTMENT CLASS LIST /</span> SESSION -- <span id="proceedSessionName">
                <script>
                ...
                <div class="field-inner-div student-result-field-inner-div">
                    <div class="alert alert-success top-alert-div animated fadeIn">
                        <div>
                            ...
                            / DEPARTMENT -- <span id="accountDepartment">
                                <script>
                                    $("#accountDepartment").html(useAccountStudentByClassSession?.departmentData?.departmentName);
                                </script>
                            </span>
                            / CLASS -- <span id="AccountClass">
                                <script>
                                    $("#AccountClass").html(useAccountStudentByClassSession?.classData?.className + ' ' + useAccountStudentByClassSession?.armData?.armName);
                                </script>
                            </span>
                            </span>
                        </div>
                    ...
                    <div class="table-div animated fadeIn">
                        <table class="table" cellspacing="0" style="width:100%" id="accountPageContent">
                            <script>
                                $(document).ready(function() {
                                    const response = JSON.parse(sessionStorage.getItem("useAccountStudentByClassSession"));
                                    ...
                                    if (response && response.success === true) {
                                        ...
                                        data.forEach(item => {
                                            ...
                                            <tr class="tb-row">
                                                ...
                                                <td><s>N</s>${thousandSeperator(item.totalMandatoryAmountPaid)}</td>
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="studentPayFullName">
                                            <script>
                                                $("#studentPayFullName").html(getEachAccountStudentSession?.studentData?.surName + ' ' + getEachAccountStudentSession?.studentData?.firstName + ' ' + getEachAccountStudentSession?.studentData?.otherNames);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="studentPayBranchName">
                                            <script>
                                                $("#studentPayBranchName").html(useAccountFessToPaySession?.branchData?.branchName);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="studentPayDepartment">
                                            <script>
                                                $("#studentPayDepartment").html(useAccountFessToPaySession?.departmentData?.departmentName);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="studentPayClassName">
                                            <script>
                                                $("#studentPayClassName").html(useAccountFessToPaySession?.classData?.className + ' ' + useAccountFessToPaySession?.armData?.armName);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                            ...
                            <div class="alert-list-back-div">
                                <div class="alert-list">
                                    ...
                                    <div><span id="studentPayCurrentTerm">
                                            <script>
                                                $("#studentPayCurrentTerm").html(useAccountFessToPaySession?.termData?.currentTerm);
                                            </script>
                                        </span></div>
                                </div>
                            </div>
                        ...
                        <div class="alert-list-back-div">
                            <div class="alert-list">
                                ...
                                <div>
                                    ...
                                    <script>
                                        $("#walletBalance").html('<s>N</s>' + thousandSeperator(useAccountFessToPaySession?.branchData?.walletBalance));
                                    </script>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert-list-back-div">
                            <div class="alert-list">
                                ...
                                <div>
                                    ...
                                    <script>
                                        $("#schoolBoltCharges").html('<s>N</s>' + thousandSeperator(useAccountFessToPaySession?.schoolBoltCharges));
                                    </script>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    <button class="btn" title="Make Payment" id="paymentBtn" onclick="_proceedToPayment();"> <i class="bi-check"></i> MAKE PAYMENT </button>
                </div>
            </div>
        </div>
    </div>
        ...
        function _calculatePaymentSummary() {
            ...
            if (newBalance >= 0) {
                ...
                $("#newAdvancedBalance").html(
                    '<span style="color:red;">- <s>N</s>' + thousandSeperator(Math.abs(newBalance)) + ' (Insufficent Funds)</span>'
                );
            }
        }
