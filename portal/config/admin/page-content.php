...
<div class="form-div animated fadeIn" id="viewLogin" data-aos="zoom-in" data-aos-duration="1200">
    <div class="inner-form">
        ...
        <button class="btn" id="submit_btn" title="Log In" onclick="_confirmLogin();">Log In <i
                class="bi-check"></i></button>
        <div class="reset-password">
            Forgot Password? <span onclick="_nextLoginPage({divid:'reset_pass_id', page: 'forget-password'});">RESET
                PASSWORD</span>
        </div>
    </div>
</div>
...
<div class="form-div animated fadeIn" data-aos="zoom-in" data-aos-duration="1200">
    <div class="inner-form">
        ...
        <button class="btn" id="proceedBtn" title="Proceed" onclick="_proceedResetPassword();">Proceed <i
                class="bi-arrow-right"></i></button>
        <div class="reset-password show">
            Already have an account? <span onclick="_nextLoginPage({divid:'login_id', page: 'login'});">LOG-IN
                HERE</span>
        </div>
    </div>
</div>
...
<div class="form-div animated fadeIn" data-aos="zoom-in" data-aos-duration="1200">
    <div class="inner-form">
        ...
        <button class="btn" type="button" id="submit_btn" title="Okay"
            onclick="location.href='<?php echo $websiteUrl ?>/admin/login'">
            OKAY <i class="bi-check2-all"></i>
        </button>
        <div class="notification"><strong>MAIL</strong> not received? <span><i class="bi-send"></i> <button
                    class="resend-btn" id="resendBtn"
                    onclick="_proceedResetPassword(staffEmailSession.email, 'resendBtn');"><strong
                        title="RESEND MAIL">RESEND MAIL</strong> </button></span></div>
    </div>
</div>
<script>
...
<div class="form-div animated fadeIn" data-aos="zoom-in" data-aos-duration="1200">
    <div class="inner-form">
        ...
        <div class="pswd_info"><em>At least 8 charaters required including upper & lower cases and special characters
                and numbers.</em></div>
...
<div class="form-div animated fadeIn" data-aos="zoom-in" data-aos-duration="1200">
    <div class="inner-form">
        ...
        <div class="alert alert-failed login-form-alert">Kindly reset your password again or contact your
            <strong>Administrator</strong> to continue.</div>
