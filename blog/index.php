...
<head>
    ...
    <title><?php echo $appName ?> | Blogs & Articles</title>
            ...
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a href="<?php echo $websiteUrl?>/blog"><li title="Blog & Article">Blog & Article</li></a>					
                    </ul>
                </div>			
            </div>
                ...
                <div class="page-back-div">
                    ...
                    <div class="left-div">
                        <div class="page-list-back-div">
                            ...
                            <a href="<?php echo $websiteUrl?>" title="Top 5 Benefits of Using SchoolBolt for Your School">
                            <div class="main-blog-div">
                                <div class="top-text">SchoolBolt</div>
                                <div class="image-div">
                            ...
                            <a href="<?php echo $websiteUrl?>" title="How SchoolBolt Simplifies Fee Payment Tracking">
                            <div class="main-blog-div">
                                <div class="top-text">SchoolBolt</div>
                                <div class="image-div">
