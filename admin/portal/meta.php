...
<script src="<?php echo $websiteUrl?>/admin/portal/js/jquery.datetimepicker.js"></script>
<script src="<?php echo $websiteUrl?>/admin/portal/js/chart.min.js"></script>
<script src="<?php echo $websiteUrl?>/admin/portal/js/canvasjs.min.js" type="text/javascript"></script>

<script src="<?php echo $websiteUrl?>/admin/portal/js/useDashboard.js?v=<?php echo $codeVersion?>" type="text/javascript"></script>
...
<script src="<?php echo $websiteUrl?>/admin/portal/js/useGallery.js?v=<?php echo $codeVersion?>" type="text/javascript"></script>
...
<script src="<?php echo $websiteUrl?>/admin/portal/js/account-report/useAccountReport.js?v=<?php echo $codeVersion?>" type="text/javascript"></script>
<script src="<?php echo $websiteUrl?>/admin/portal/js/useSchools.js?v=<?php echo $codeVersion?>" type="text/javascript"></script>